...
--- Generate lualine theme for gruvbox
---@param variant string? "dark" | "light" | nil (auto-detect from background)
Gruvbox.lualine = function(variant)
  local bg = variant or vim.o.background
  local colors = get_colors()
  
  -- Override colors based on variant if specified
  if variant and variant ~= vim.o.background then
    local p = Gruvbox.palette
    local config = Gruvbox.config
